...
namespace ARPatients.Controllers
{
    ...
    public class ARMedicationsController : Controller
    {
        
        private readonly Patients _context;

        public ARMedicationsController(Patients context)
        {
            _context = context;
        }
        ...
        {
            Response.Cookies.Append("medTypeId", Request.Query["medId"]);
          //  ViewBag.medTypeId = medTypeId;
            
            var patients = _context.Medication.Include(m => m.ConcentrationCodeNavigation).Include(m => m.DispensingCodeNavigation).Include(m => m.MedicationType);
            return View(await patients.ToListAsync());
        }

        // GET: ARMedications/Details/5
